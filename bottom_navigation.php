      ...
      <div class="col-6 col-md-2 mb-3">
        ...
        <ul class="nav">
          ...
          <li class="nav-item mb-2">
            ...
            </svg> Video Content Creation
          </li>
          
          <li class="nav-item mb-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
              <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0"/>
            </svg> Search Engine Optimization
          </li>
-->
          <li class="nav-item mb-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-file-earmark-code-fill" viewBox="0 0 16 16">
...
<!--
          <li class="nav-item mb-2"> 
            ...
            </svg> Lead Capture Automation
          </li>

          <li class="nav-item mb-2"> 
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-ticket-detailed-fill" viewBox="0 0 16 16">
            ...
            </svg> Customer Support Ticket Automation
          </li>
-->
        </ul>
      </div>

      <!-- Get in touch section with email and phone number -->
      <div class="col-6 col-md-2 mb-3">
        <h5>Get In Touch</h5>
        <ul class="nav">
          <li class="nav-item mb-2">
      ...
      <div class="col-md-3 mb-3">
        <div class="container d-flex flex-wrap justify-content-center">
          <a href="index.php" class="">
            <img src="img/smx_logo.png" class="mr-3 rounded mx-auto d-block" class="lazy" loading="lazy" alt="..." height="200" width="200">
          </a>      
          <p>&nbsp;<b>SMX Afrika Enterprises</b> &reg;</p>
        </div>
      </div>
    ...
    <div class="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
      <p>&copy; SMX Afrika Enterprises, (Pty) Ltd. All rights reserved.</p>
 
      <!-- Cookies, & Privacy Policy Links to their documents section -->
    <ul class="list-unstyled d-flex">
        <li class="ms-3"><a class="link-body-emphasis" href="#">
          <a href="pdf/smx ae privacy.pdf" target="_blank" class="nav-link">Privacy Policy</a>
        </li>
        ...
        <li class="ms-3"><a class="link-body-emphasis" href="#">
          <a href="pdf/smx ae cookies.pdf" target="_blank" class="nav-link" >Cookies</a>
        </li>
      </ul>
      ...
      <ul class="list-unstyled d-flex">
        ...
        <li class="ms-3"><a class="link-body-emphasis" href="#">
          ...
          <!-- Back to top botton section  -->
    <button class="float-end btn btn-primary mb-5" type="button">
      Back to top
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-arrow-bar-up"viewBox="0 0 14 13">
